...
export default function Calendar() {
  ...
  return (
    <div className="p-5 bg-light-sky-blue flex justify-center pb-10 shadow-md shadow-natural-charcoal/40 md:mx-7.5 rounded-xl">
      <div className="sm:px-0 flex flex-col gap-5 max-w-100 md:grid md:grid-cols-2">
        {/* Header */}
